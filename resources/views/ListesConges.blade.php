...
Les demandes de congé traitées
@endsection
@section('content')
  ...
  <div class="col-lg-4 col-md-6 mb-4 card-deck ">
            <div class="card card-deck" >
              <div class="row ">
                <div class="col-lg-12">
                  <div class="card-body">
                  <h4 class="card-title txt">{{ $item->prenom }} {{ $item->nom }} </h4>
          ...
          <p class="card-text txt"><a href="/RespRh/DemandesConges/{{$item->id_conge}}/view" class="btn vert-button">Afficher</a>
         
          <a href="#" class="ml-1 btn move-button" data-toggle="modal" data-target="#confirmDeleteModal{{$item->id_conge}}">
    Supprimer
    </a>
        </p>
        </div>
...
<div class="modal fade" id="confirmDeleteModal{{$item->id_conge}}" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel{{$item->id_conge}}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content"style="color:black;">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmDeleteModalLabel{{$item->id_conge}}">Confirmation de la suppression</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            <i class="fa-sharp fa-solid fa-circle-exclamation fa-lg" style="color:red;"></i> Êtes-vous sûr de vouloir supprimer cette demande de congé ?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn vert-button" data-dismiss="modal">Annuler</button>
                <a href="/RespRh/DemandesConges/{{$item->id_conge}}/delete" class="btn move-button">Supprimer</a>
            </div>
        </div>
    </div>
</div> 
...
<div class="container m-3 ">
  ...
  <h3  class="text-center" style="color:black;">Aucune demande n'a été traitée  pour le moment.</h3></div>
