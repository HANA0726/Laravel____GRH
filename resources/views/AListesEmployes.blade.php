...
<a href="{{route('admin.ajouter.employe')}}"class="btn vert-button" ><i class="fa-sharp fa-solid fa-plus fa-xl" style="color: #ffffff;"></i> Ajouter Employé</a> 
</div>
    ...
    <input class="form-control m-1" name="search" id="search" type="search" placeholder="Chercher" aria-label="Search">
      ...
      <div class="container mb-5 ">
        ...
        @endif
           ...
           <p class="card-text social-media"><a href="/admin/ListesEmployes/{{$item->id_employer}}/view"><i class="fa-solid fa-eye  fa-xl" style="color:#952D98;"></i></a>
       <a href="/admin/ListesEmployes/{{$item->id_employer}}/edit"> <i class="fa-regular fa-pen-to-square fa-xl" style="color: #00ed64;"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content"style="color:black;">
            ...
            <div class="modal-footer">
                ...
                <a href="/admin/ListesEmployes/{{$item->id_employer}}/delete" class="btn move-button">Supprimer</a>
            </div>
        </div>
    </div>
</div> 
...
<script type="text/javascript">
                ...
                "<img src='" + photoUrl + "' class='img'>" +
                    "<div class='card-body'>" +
                      ...
                      "<p class='card-text social-media'>" +
                        "<a href='/admin/ListesEmployes/" + employee.id_employer + "/view' class=' ml-2'>" +
                          "<i class='fa-solid fa-eye  fa-xl' style='color:#952D98;'></i>" +
                        "</a>" +
                        "<a href='/admin/ListesEmployes/" + employee.id_employer + "/edit' class=' ml-2'>" +
    ...
    "<div class='modal-footer'>" +
    "<button type='button' class='btn vert-button' data-dismiss='modal'>Annuler</button>" +
    "<a href='/admin/ListesEmployes/" + employee.id_employer + "/delete' class='btn move-button'>Supprimer</a>" +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>";
