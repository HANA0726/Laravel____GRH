...
<div class="col-lg-4 col-md-6 mb-4 card-deck">
    ...
    <p class="card-text   txt">Mois :  <span class="badge " style="background-color:#00ED64;font-size:15px;color:#ffffff;">{{ date('F', strtotime($salaire->date)) }}</span></p>
    <p> <a href="/employer/Paiement/{{$salaire->id_salaire}}/view" class="btn move-button m-1"> Consulter</a> </p>
...
<div class="container text-center">
  ...
  <h3 class="text-center " style="color:black;">  Vos fiches  de paiement sont en cours de traitement.</h3>
</div>
