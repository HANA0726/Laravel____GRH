...
Les demandes de justifications d'absences
@endsection
@section('content')
...
<div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              <div class="row ">
                <div class="col-lg-12">
                  <div class="card-body">
    <h4 class="card-title  txt">Justificatif d'absence</h4>
    <p class="card-text  txt">Pour le jour : {{$item->date_absence}}</p>
    <p class="card-text  txt">Envoyée le: {{$item->created_at}}</p>
    <p> <a href="/employer/DemandeAbsence/{{$item->id_absence}}/justifier" class="btn vert-button">Justifier</a> </p>
...
<div class="container m-3 text-center">
 ...
 <h3 class="mb-3 text-center" style="color:black;">
    Aucune Justification n'a été  demandée  pour le moment.</h3> </div>
